# The Wall Chart Co — Digital Wall Charts for Football & Rugby

Premium digital downloads for football and rugby fans. Every product is a single HTML file that opens in any browser — no app, no install, no account needed.

**Made in Swansea, Wales** | Sold on Etsy | [TheWallChartCo](https://etsy.com)
...
1. Customer buys on Etsy (instant digital download)
2. Opens the HTML file in any browser (Chrome, Firefox, Safari, Edge)
3. Enters scores as matches are played
4. Tables and brackets update automatically
5. Progress auto-saves in the browser
...
- **Name:** The Wall Chart Co (TWC)
- **Colours:** Navy `#0B1E3D` · Red `#C8502A` · Gold `#C8A94A` · Cream `#F7F5EE`
- **Fonts:** EB Garamond (headings) · Inter (body/UI)
- **Tagline:** Premium Tournament Downloads

---

## Disclaimer

All products are unofficial. Not affiliated with or endorsed by FIFA, UEFA, the Premier League, Six Nations Rugby, World Rugby, or any club, union or national team.

© 2026 The Wall Chart Co. Personal use only.
